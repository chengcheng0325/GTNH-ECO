...
public class MTEEcalArray extends TTMultiblockBase implements ISurvivalConstructable {
    ...
    /**
     * t65→t128: byte-pool cap by the activated cell main-chain node (docs §2 revision) — one cap
    ...
    /**
     * t65→t128: the upgrade tree (docs/ECO_UPGRADE_TREE_DESIGN.md) — 17 nodes (single cell main
     * chain N1-N5 + thread T1-T3 / parallel P1-P3 / hyper H1-H3 branches + built-in B1/B2 +
     * overclock OC; T4/T5 removed in t128), activation state persisted in NBT ("upgradeTree"
    ...
    /**
     * t65/t128: byte-pool cap by the activated cell main-chain node — one node per MERGED GROUP
