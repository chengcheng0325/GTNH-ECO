...
public class TileEcoStorageDrive extends TileEcoStoragePart implements IInventory, ISaveProvider {
    ...
    /**
     * t112→t128b (upgrade-tree gate): node id required by the cell on its storage line — ONE NODE
    ...
    /**
     * t112→t128b (upgrade-tree restriction, docs §3): each cell needs its chain's MERGED GROUP
