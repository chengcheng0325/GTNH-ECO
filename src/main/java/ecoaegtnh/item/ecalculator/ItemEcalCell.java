 ...
 * <p>
 * t128: the upgrade-tree gate maps the cell onto the merged main-chain node N1..N5 (see
...
public class ItemEcalCell extends Item {
    ...
    /**
     * t65/t114→t128 (upgrade tree, docs §2 revision): the cell main-chain node required to insert
