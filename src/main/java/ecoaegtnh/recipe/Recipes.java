...
public final class Recipes {
    ...
    private static void registerComponentChain() {
        ...
        tryAddAL(
            ...
            new FluidStack[] { gtFluid(1081, 576) },
        ...
        tryAddAL(
            ...
            new FluidStack[] { gtFluid(1081, 8 * 144) },
        ...
        tryAddAL(
            ...
            new ItemStack[] { findItemStack("appliedenergistics2", "item.ItemMultiMaterial", 60, 16), oc103,
                ...
                gt32676, bm1748 },
            new FluidStack[] { gtFluid(1081, 16 * 144) },
        ...
        tryAddAL(
            ...
            new FluidStack[] { gtFluid(1081, 18 * 144) },
        ...
        tryAddAL(
            ...
            new FluidStack[] { gtFluid(434, 6 * 144), gtFluid(1081, 12 * 144) },
        ...
        tryAddAL(
            ...
            new FluidStack[] { gtFluid(434, 12 * 144), gtFluid(1081, 16 * 144) },
        ...
        tryAddSpaceAssembler(
            ...
            new FluidStack[] { gtFluid(821, 36864) },
        ...
        tryAddSpaceAssembler(
            ...
            new ItemStack[] { new ItemStack(com.glodblock.github.loader.ItemAndBlockHolder.ARTIFICIAL_UNIVERSE_CELL, 1),
                findItemStack("bartworks", "gt.bwMetaGeneratedplateDense", 10112, 64),
                findItemStack("gregtech", "gt.metaitem.01", 32047, 6),
        ...
        tryAddSpaceAssembler(
            ...
            new FluidStack[] { gtFluid(1127, 16 * 144), gtFluid(3, 24000) },
            new ItemStack(
    ...
    private static void registerEcalFlashCells() {
        ...
        tryAddAL(
            ...
            new FluidStack[] { gtFluid(1081, 4 * 144) },
            new ItemStack(
